...
CREATE OR REPLACE TYPE tp_usuario_base AS OBJECT (
    ...
    NOT INSTANTIABLE MEMBER FUNCTION detalhes RETURN VARCHAR2,
...
/
------
ALTER TYPE tp_canal_base ADD ATTRIBUTE categoria VARCHAR2(50) CASCADE;
------
ALTER TYPE tp_canal_base ADD MEMBER FUNCTION eh_popular RETURN VARCHAR2 CASCADE;
------
